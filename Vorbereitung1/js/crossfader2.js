...
var sounds = {
  laser : {
    src : './NarutoInstrumental.mp3'
  },
  coin : {
    src : './cantStopThisMotherfuckerVocal.mp3'
  },
...
CrossfadeSample.play = function() {
  // Create two sources.
  this.ctl1 = createSource(loadSoundObj(sounds.coin));
  this.ctl2 = createSource(loadSoundObj(sounds.laser));
